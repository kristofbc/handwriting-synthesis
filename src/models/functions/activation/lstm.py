...
class LSTM(function.Function):
    ...
    """
        ...
        **EXACT IMPLEMENTATION OF LSTM FROM CHAINER=2.0.2 BUT WITH GRADIENT CLIPPING
    ...
    def backward(self, inputs, grad_outputs):
        ...
        """ CLIP GRADIENT """
        gc_prev = clip_grad(gc_prev, -10.0, 10.0, x.shape[0])
        gx = clip_grad(gx, -10.0, 10.0, x.shape[0])
